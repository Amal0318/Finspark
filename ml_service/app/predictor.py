...
class ModelPredictor:
    def __init__(self):
        # Locate the models directory relative to the current file
        self.models_dir = os.path.join(
            os.path.dirname(os.path.abspath(__file__)), "models"
        )
        self.iforest = self._load_model("isolation_forest.pkl")
        self.rf_clf = self._load_model("random_forest.pkl")
