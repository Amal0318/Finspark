...
app = FastAPI(
    ...
    description="CyberSense - Cybersecurity Telemetry & Banking Transaction Correlation Engine",
    version="1.0.0",
...
app.include_router(ml_router, prefix=settings.API_V1_STR, tags=["CyberSense Core"])
